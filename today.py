...
#   - ACCESS_TOKEN: Fine-grained PAT with read:Followers, read:Starring, read:Watching, read:Contents, read:Metadata
...
if __name__ == '__main__':
    ...
    # Optional: Add archived repo data for deleted repos you contributed to.
    # Create cache/repository_archive.txt and uncomment below. See add_archive() for format.
    # if OWNER_ID == {'id': 'YOUR_GITHUB_USER_ID'}:
